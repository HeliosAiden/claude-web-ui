...
type GitlabCredentialsSectionProps = {
  gitlabCredentials: GitlabCredentialItem[];
...
export default function GitlabCredentialsSection({
  ...
  return (
    <div>
      ...
      <p className="mb-4 text-sm text-muted-foreground">{t('apiKeys.gitlab.descriptionAlt')}</p>
      ...
      {showNewGitlabForm && (
        <div className="mb-4 space-y-3 rounded-lg border bg-card p-4">
          ...
          >
            {t('apiKeys.gitlab.form.howToCreate')}
          </a>
        </div>
      )}
